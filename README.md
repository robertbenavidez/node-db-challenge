...
- [X] Explain the difference between `Relational Databases` and `SQL`.
  ...
  A relational database is a method of model data using tables and columns, as well as ids to reference tables to one another. SQL is the language used to traverse the tables in a relational database

- [X] Why do tables need a `primary key`?

  Primary keys are used to reference tables and columns in a relational database.
...
- [X] What do we need in order to have a _many to many_ relationship between two tables.
  ...
  We need an cross-reference table that contains the primary id of both tables.
